...
UiPage({
    $id: Now.ID['733f87248e52454ab6b7170c061f3116'],
    category: 'general',
    endpoint: 'x_1966129_transpar_incident_manager.do',
...
window.g_ck = "$[gs.getSession().getSessionToken() || gs.getSessionToken()]";</script>
    ...
    <script src="/uxasset/externals/x_1966129_transpar/main.jsdbx?uxpcb=$[UxFrameworkScriptables.getFlushTimestamp()]" type="module"></script>
  </head>
  <body>
    <div id="root"></div>
  </body>
